import { CommonProps } from '@el-cool/components/cascader-panel'
import { buildProps, definePropType, isBoolean } from '@el-cool/utils'
import { useEmptyValuesProps, useSizeProp } from '@el-cool/hooks'
import { useTooltipContentProps } from '@el-cool/components/tooltip'
import { tagProps } from '@el-cool/components/tag'
import { CHANGE_EVENT, UPDATE_MODEL_EVENT } from '@el-cool/constants'
import type {
    CascaderNode,
    CascaderValue,
