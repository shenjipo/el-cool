...
import ConfigProvider from '@el-cool/components/config-provider'
import { CommonPicker } from '@el-cool/components/time-picker'
import Input from '@el-cool/components/input'
import zhCn from '@el-cool/locale/lang/zh-cn'
import enUs from '@el-cool/locale/lang/en'
import 'dayjs/locale/zh-cn'
import { EVENT_CODE } from '@el-cool/constants'
import { ElFormItem } from '@el-cool/components/form'
