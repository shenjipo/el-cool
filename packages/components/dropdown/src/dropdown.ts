// @ts-nocheck
import { buildProps, definePropType, iconPropType } from '@el-cool/utils'
import { EVENT_CODE } from '@el-cool/constants'
import { createCollectionWithScope } from '@el-cool/components/collection'
import {
    useTooltipContentProps,
    useTooltipTriggerProps,
} from '@el-cool/components/tooltip'

import type { Options } from '@popperjs/core'
import type { ButtonProps, ButtonType } from '@el-cool/components/button'
import type { Placement } from '@el-cool/components/popper'
import type { ComponentInternalInstance, ComputedRef } from 'vue'
import type { Nullable } from '@el-cool/utils'
