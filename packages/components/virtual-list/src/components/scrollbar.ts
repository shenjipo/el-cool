...
import { BAR_MAP } from '@el-cool/components/scrollbar'
import { cAF, rAF } from '@el-cool/utils'
...
const ScrollBar = defineComponent({
    ...
    setup(props, { emit }) {
        ...
        const trackStyle = computed<CSSProperties>(() => ({
            position: 'absolute',
            width: `${HORIZONTAL === props.layout ? trackSize.value : props.scrollbarSize
                }px`,
            height: `${HORIZONTAL === props.layout ? props.scrollbarSize : trackSize.value
                }px`,
